...
def extract_frames(video_filename, video_path, frames_dir, overwrite=False, start=-1, end=-1, every=1):
    """
...
def video_to_frames(video_filename, video_path, frames_dir, overwrite=False, every=1):
    """
    ...
    extract_frames(video_filename, video_path, frames_dir, every=every)  # let's now extract the frames
